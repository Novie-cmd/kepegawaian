      ...
      <div className="max-w-[850px] mx-auto bg-white shadow-2xl p-10 md:p-16 text-black font-serif relative leading-normal print:shadow-none print:max-w-none print:w-full print:p-0">
        ...
        <div className="flex items-center border-b-[3px] border-black pb-2 mb-1 relative print:mt-2 min-h-[150px]">
          ...
          <div className="flex-1 text-center pr-10">
            <h1 className="text-[12px] font-normal uppercase tracking-tight leading-tight">Pemerintah Provinsi Nusa Tenggara Barat</h1>
            <h2 className="text-[15px] font-bold uppercase leading-tight mt-1 whitespace-nowrap">Dinas Penanaman Modal dan PTSP</h2>
            <h2 className="text-[15px] font-bold uppercase leading-tight whitespace-nowrap">Provinsi Nusa Tenggara Barat</h2>
