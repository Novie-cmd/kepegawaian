      ...
      <div className="max-w-[850px] mx-auto bg-white shadow-2xl p-10 md:p-16 text-black font-serif relative leading-normal print:shadow-none print:max-w-none print:w-full print:p-0">
        ...
        <div className="flex items-center border-b-[3px] border-black pb-1 mb-1 relative print:mt-2 min-h-[140px]">
          ...
          <div className="flex-1 text-center pr-12">
            ...
            <p className="text-[10px] font-sans font-bold text-blue-700 underline">Website: dpmptsp.ntbprov.go.id</p>
          </div>
        </div>
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/70 backdrop-blur-sm animate-fadeIn">
      <div className="bg-white rounded-[2.5rem] shadow-2xl w-full max-w-4xl overflow-hidden flex flex-col max-h-[95vh] border border-slate-100">
        ...
        <div className="px-8 py-6 border-b border-slate-100 flex justify-between items-center bg-white">
          ...
          <div className="flex items-center space-x-3">
             <button 
              ...
              >
                {isScanning ? 'Extrak...' : 'Scan Dokumen AI'}
        ...
        <div className="flex-1 overflow-y-auto p-10 bg-slate-50/30">
          <form id="employee-form" onSubmit={handleSubmit} className="space-y-8 max-w-2xl mx-auto">
            {activeTab === 'DATA' && (
              <div className="grid grid-cols-2 gap-6 animate-fadeIn">
                ...
                <div>
                  <label className="block text-[10px] font-black text-slate-400 uppercase tracking-widest mb-1.5">Golongan</label>
            ...
            {activeTab === 'SKP_LAMA' && (
              <div className="grid grid-cols-2 gap-6 animate-fadeIn">
                <div>
                  ...
                  <input name="gajiPokokLama" value={formData.gajiPokokLama} onChange={handleInputChange} placeholder="Rp. 0" className="w-full px-5 py-3.5 bg-white border border-slate-200 rounded-xl font-bold text-slate-800 outline-none" />
                </div>
                <div>
                  <label className="block text-[10px] font-black text-slate-400 uppercase tracking-widest mb-1.5">Nomor SKP</label>
                ...
                <div>
                  <label className="block text-[10px] font-black text-slate-400 uppercase tracking-widest mb-1.5">Tgl SKP</label>
                ...
                <div>
                  <label className="block text-[10px] font-black text-slate-400 uppercase tracking-widest mb-1.5">Tgl Mulai Gaji</label>
            ...
            {activeTab === 'SKP_BARU' && (
              <div className="grid grid-cols-2 gap-6 animate-fadeIn">
                <div className="col-span-2 flex justify-end">
                  <button type="button" onClick={() => setShowPreview(true)} className="px-4 py-2 bg-emerald-600 text-white rounded-xl text-[10px] font-black uppercase tracking-widest flex items-center space-x-2">
                ...
                <div>
                  ...
                  <input name="gajiPokokBaru" value={formData.gajiPokokBaru} onChange={handleInputChange} className="w-full px-5 py-3.5 bg-white border border-slate-200 rounded-xl font-bold text-slate-800 outline-none" />
                </div>
                <div>
                  <label className="block text-[10px] font-black text-slate-400 uppercase tracking-widest mb-1.5">TMT KGB Baru</label>
